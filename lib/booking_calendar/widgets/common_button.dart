...
class CommonButton extends StatelessWidget {
  ...
  Color _getButtonColor() {
    if (isActive == true && isDisabled == false) {
      return buttonActiveColor ?? Colors.blue;
    } else if (isActive == false && isDisabled == false) {
      return Colors.white;
    } else {
      return buttonInActiveColor ?? Colors.blue.shade100;
    }
  }
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: (isActive == false && isDisabled == false) ? Border.all(color: Colors.blue, width: 2) : null,
        ),
        child: Text(
          text,
